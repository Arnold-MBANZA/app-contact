...
export default function AddContact() {
    ...
    return (
        <form className='mt-2 flex' onSubmit={handleSubmitForm}>
            <div className="form-group">
                <label htmlFor="nom">Nom du contact</label>
                <input type="text" name="nom" placeholder="Arnold Mbanza" required minLength={4} />
            </div>
            <div className="form-group">
                <label htmlFor="email">Adresse mail</label>
                <input type="email" name="email" placeholder="arnombanza@gmail.com" required />
            </div>
            <div className="form-group">
                <label htmlFor="numTel">Numéro de téléphone</label>
                <input type="tel" name="numTel" placeholder="+243 896 441 225" required minLength={10} />
            </div>
